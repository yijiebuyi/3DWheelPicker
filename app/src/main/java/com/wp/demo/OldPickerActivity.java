...
import com.wheelpicker.OldDataPicker;
...
public class OldPickerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picker_old);
        mContext = this;
        ...
        findViewById(R.id.picker_birthday).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PickOption option = getPickDefaultOptionBuilder(mContext)
                        ...
                        .build();
                OldDataPicker.pickBirthday(mContext, mInitBirthday, option,
        ...
        findViewById(R.id.picker_date).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PickOption option = getPickDefaultOptionBuilder(mContext)
                        ...
                        .setAfterYears(100)
                        .build();
                OldDataPicker.pickDate(mContext, mInitDate, option, new OnDatePickListener() {
                            @Override
                            public void onDatePicked(IDateTimePicker dateTimePicker) {
        ...
        findViewById(R.id.picker_future_date).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PickOption option = getPickDefaultOptionBuilder(mContext)
                        ...
                        .setAfterYears(100)
                        .build();
                OldDataPicker.pickDate(mContext, mInitFutureDateTime, option, new OnDatePickListener() {
        ...
        findViewById(R.id.picker_future).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PickOption option = getPickDefaultOptionBuilder(mContext)
                        ...
                        .setDurationDays(100)
                        .build();
                OldDataPicker.pickFutureDate(OldPickerActivity.this, new Date(System.currentTimeMillis() + 30 * 60 * 1000),
        ...
        findViewById(R.id.picker_txt).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PickOption option = getPickDefaultOptionBuilder(mContext)
                        ...
                        .build();
                OldDataPicker.pickData(OldPickerActivity.this, mInitData, getStudents(1), option, new OnDataPickListener<Student>() {
                    @Override
                    public void onDataPicked(int index, String val, Student data) {
                        mInitData = data;
                        Toast.makeText(OldPickerActivity.this, val, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
        ...
        findViewById(R.id.multi_picker_txt).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                OldDataPicker.pickData(mContext, mMultiInitIndex, stu, option, new OnMultiDataPickListener<Student>() {
    ...
    private void pickCity(int mode, final List<Integer> initIndex) {
        if (mAdministrativeMap == null) {
            mAdministrativeMap = AdministrativeUtil.loadCity(OldPickerActivity.this);
        }
        ...
        OldDataPicker.pickData(mContext, initIndex,
                ...
                new OnMultiDataPickListener() {
                    ...
                    public void onDataPicked(List indexArr, List val, List data) {
                        String s = indexArr.toString() + ":" + val.toString();
                        Toast.makeText(OldPickerActivity.this, s, Toast.LENGTH_SHORT).show();
                        initIndex.clear();
